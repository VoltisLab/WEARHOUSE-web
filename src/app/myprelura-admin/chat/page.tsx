...
export default function StaffMessagesInboxPage() {
        ...
        <GlassCard>
          <div className="flex flex-col items-center gap-3 py-8 text-center">
            ...
            <p className="max-w-sm text-[14px] text-prel-secondary-label">
              Threads you open from orders, reports, or the consumer app will
              show here when this account is a participant.
            </p>
          </div>
        </GlassCard>
      )}
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-1 flex flex-wrap items-center gap-2">
                        <span className="rounded-full bg-prel-primary/15 px-2 py-0.5 text-[10px] font-bold uppercase text-prel-primary">
                          {threadBadge(c)}
                        </span>
                        {unread ? (
                          <span className="text-[11px] font-semibold text-prel-primary">
